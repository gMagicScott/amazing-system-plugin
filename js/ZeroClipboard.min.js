...
jQuery(document).ready(function ($) {
  ZeroClipboard.config( amsys_tinymce_data.ZeroClipboardConfig );

  var client = new ZeroClipboard($('#zero_clipboard'));

  $('#zero_clipboard').on('click', function(e) {
    e.preventDefault();
    $('#copySuccess').fadeIn(500);
    // $('#zero_clipboard').html('Copied!');
    // $('#_as_1Shop_Link').css('width', '85%');
    setTimeout(function(){
      $('#copySuccess').fadeOut(500);
      // $('#zero_clipboard').html('Copy to Clipboard');
      // $('#_as_1Shop_Link').css('width', '72%');
    }, 2000);
    // var value = $('#amsys_link_desc').value;
    // var inner = this.innerHTML();
    // this.innerHTML('Copied!');
    // alert('Link has been copied to your clipboard!');
  });
  // $(".amsys_cap_settings").hide();
  // // var formHtml = $('#_as_the_form').value;
  // var formHtml = document.getElementById('_as_the_form').value;
  // var formInputIds = [];
  // $(formHtml).find('input').each(function() {
  // 	if ( undefined !== $(this).attr('id') ) {
  // 		formInputIds.push($(this).attr('id'));
  // 	}
  // });
  //
  // var select = $("#_as_test_multicheckbox_cap");
  // for (var i = 0; i < formInputIds.length; i++) {
  // 	select.append(function() {
  // 		return $("<option>" + formInputIds[i] + "</option>");
  // 	});
  // }
  //
  // select.children("[disabled=disabled]").remove();
  //
  // // console.log(select);
  //
  // $("#_as_test_multicheckbox1").on('click', function() {
  // 	if ( $(this).attr('checked') !== undefined ) {
  // 		$(".amsys_cap_settings").show();
  // 	} else {
  // 		$(".amsys_cap_settings").hide();
  // 	}
  // });
