		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'text':
					...
					break;
				case 'text_disabled':
					echo '<input readonly="readonly" style="width: 70%; margin-right: 5px;" onClick="this.select();" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" />','<button type="button" id="zero_clipboard" class="button button-secondary" data-clipboard-text="', '' !== $meta ? $meta : $field['std'], '">Copy to Clipboard</button><span id="copySuccess" style="display:none;font-style:normal;margin-left:10px;background-color:#222;padding:6px;color:white;border-radius:5px;"><strong style="font-weight:bolder">Copied!</strong></span>','<p class="cmb_metabox_description">', $field['desc'], '</p>';
					break;
				case 'text_small':
