...
jQuery(document).ready(function ($) {
  ...
  ZeroClipboard.on('error', function(e) {
  	...
  	$('#zero_clipboard_as_1Shop_Link').remove();
  	$('#copySuccess_as_1Shop_Link').remove();
  	$('#zero_clipboard_as_TY_URL').remove();
  	$('#copySuccess_as_TY_URL').remove();
  	bail = true;
  });
  ...
  var clientOne = new ZeroClipboard($('#zero_clipboard_as_1Shop_Link'));
  clientOne.on('ready', function(){
  	this.on("aftercopy", function(event) {
      $('#copySuccess_as_1Shop_Link').fadeIn(500);
      setTimeout(function(){
      	$('#copySuccess_as_1Shop_Link').fadeOut(500);
      }, 2000);
    });
  });

  var clientTwo = new ZeroClipboard($('#zero_clipboard_as_TY_URL'));
  clientTwo.on('ready', function(){
  	this.on("aftercopy", function(event) {
  		$('#copySuccess_as_TY_URL').fadeIn(500);
  		setTimeout(function(){
  			$('#copySuccess_as_TY_URL').fadeOut(500);
  		}, 2000);
  	});
  });
});
